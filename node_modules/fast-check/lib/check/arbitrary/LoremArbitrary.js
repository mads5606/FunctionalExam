...
var h = function (v, w) {
    return { arbitrary: ConstantArbitrary_1.constant(v), weight: w };
};
...
function lorem(maxWordsCount, sentencesMode) {
    ...
    if (sentencesMode) {
        var sentence = ArrayArbitrary_1.array(loremWord(), 1, 10)
        ...
        return ArrayArbitrary_1.array(sentence, 1, maxCount).map(function (sentences) { return sentences.join(' '); });
    }
    else {
        return ArrayArbitrary_1.array(loremWord(), 1, maxCount).map(function (words) {

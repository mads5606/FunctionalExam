    ...
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                g_1 = tslib_1.__values(g), g_1_1 = g_1.next();
                _b.label = 1;
            case 1:
...
function flatMapHelper(g, f) {
    ...
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 5, 6, 7]);
                g_2 = tslib_1.__values(g), g_2_1 = g_2.next();
                _b.label = 1;
            case 1:
                if (!!g_2_1.done) return [3, 4];
                v = g_2_1.value;
                return [5, tslib_1.__values(f(v))];
            case 2:
                _b.sent();
                _b.label = 3;
            case 3:
...
function filterHelper(g, f) {
    ...
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 5, 6, 7]);
                g_3 = tslib_1.__values(g), g_3_1 = g_3.next();
                _b.label = 1;
            case 1:
    ...
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                ...
                others_1 = tslib_1.__values(others), others_1_1 = others_1.next();
                _b.label = 5;
            case 5:
